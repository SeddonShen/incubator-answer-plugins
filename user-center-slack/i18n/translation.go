...
const (
	...
	ConfigRedirectURITitle        = "plugin.slack_user_center.backend.config.redirect_uri.title"
	ConfigRedirectURIDescription  = "plugin.slack_user_center.backend.config.redirect_uri.description"
